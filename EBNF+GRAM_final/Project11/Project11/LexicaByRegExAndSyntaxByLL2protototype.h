...
/* Додано && та \|\| (екрановане ||) на початок, щоб вони розпізнавалися як один токен */
#define TOKENS_RE         ";|->|&&|\\|\\||\\+|-|\\*|,|eg|ne|:|\\[|\\]|\\(|\\)|\\{|\\}|[_0-9A-Za-z]+|[^ \t\r\f\v\n]"
#define KEYWORDS_RE       ";|->|&&|\\|\\||\\+|-|\\*|,|eg|ne|:|\\[|\\]|\\(|\\)|\\{|\\}|program|var|begin|end|input|output|if|else|goto|/|%|lt|gt|!|&|\\||int"
