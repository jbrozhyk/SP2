...
#define KEYWORDS_RE  ";|->|!!|&&|\\|\\||eg|ne|lt|gt|\\+|-|\\*|/|%|,|:|\\[|\\]|\\(|\\)|\\{|\\}|program|var|begin|end|input|output|if|else|int|goto|EXIT"
...
{ LA_IS, { T_NAME_0 }, { "program_rule",{\
    { LA_IS, {""}, 9, { T_NAME_0, "program_name", T_SEMICOLON_0, T_DATA_0, "declaration__optional", T_SEMICOLON_0, T_BODY_0, "statement__iteration", T_END_0 }}\
}}},\
