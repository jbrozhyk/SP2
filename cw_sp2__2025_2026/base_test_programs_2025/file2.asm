...
neg_and_done:
    ...
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF7EC2BD5E0
    ...
    mov eax, 1
LABEL@AFTER_THEN_00007FF7EC2BD5E0:

    ;"else" (part of "elseif")
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_00007FF7EC2BF2F8
    ...
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF7EC2C20B0
    ...
    mov eax, 1
LABEL@AFTER_ELSE_00007FF7EC2BF2F8:
LABEL@AFTER_THEN_00007FF7EC2C20B0:

    ;"else"
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_00007FF7EC2C3DC8
    ...
    ;";" (after "else")
LABEL@AFTER_ELSE_00007FF7EC2C3DC8:
    ...
    ;after cond expresion (after "if")
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF7EC2CA188
    ...
    ;";" (after "then"-part of if-operator)
    mov eax, 1
LABEL@AFTER_THEN_00007FF7EC2CA188:

    ;"else"
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_00007FF7EC2CBA78
    ...
    ;";" (after "else")
LABEL@AFTER_ELSE_00007FF7EC2CBA78:
    ...
    ;after cond expresion (after "if")
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF7EC2D11C0
    ...
    ;";" (after "then"-part of if-operator)
    mov eax, 1
LABEL@AFTER_THEN_00007FF7EC2D11C0:

    ;"else"
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_00007FF7EC2D2AB0
    ...
    ;";" (after "else")
LABEL@AFTER_ELSE_00007FF7EC2D2AB0:
    ...
    ;after cond expresion (after "if")
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF7EC2D6D30
    ...
    ;";" (after "then"-part of if-operator)
    mov eax, 1
LABEL@AFTER_THEN_00007FF7EC2D6D30:

    ;"else"
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_00007FF7EC2D8620
    ...
    ;";" (after "else")
LABEL@AFTER_ELSE_00007FF7EC2D8620:
