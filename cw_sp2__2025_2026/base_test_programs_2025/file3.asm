...
LABEL@0000018BB1B3BAD8:
    ...
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF7EC2BEAA8

    ;"goto" previous ident "_LCE"(as label)
    jmp LABEL@0000018BB1B42C28
    ...
    mov eax, 1
LABEL@AFTER_THEN_00007FF7EC2BEAA8:
...
LABEL@0000018BB1B42CE8:
    ...
    ;after cond expresion (after "if")
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF7EC2CE830

    ;"goto" previous ident "_LAE"(as label)
    jmp LABEL@0000018BB1B316C8
    ...
    ;";" (after "then"-part of if-operator)
    mov eax, 1
LABEL@AFTER_THEN_00007FF7EC2CE830:
...
LABEL@0000018BB1B31788:
    ...
    ;after cond expresion (after "if")
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF7EC2D4BF0

    ;"goto" previous ident "_LBE"(as label)
    jmp LABEL@0000018BB1B50248
    ...
    ;";" (after "then"-part of if-operator)
    mov eax, 1
LABEL@AFTER_THEN_00007FF7EC2D4BF0:
